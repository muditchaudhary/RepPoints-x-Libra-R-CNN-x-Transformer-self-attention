...
JOB_NAME=reppoints_moment_r50_fpn_2x_BLoss_CELoss_Full_Libra #job name can be anything   
CONFIG=./configs/my_configs/Libra/reppoints_moment_r50_fpn_2x_BLoss_CELoss_1_Full_Libra.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment_r50_fpn_2x_BLoss_CELoss_1_Full_Libra #where to save the models
