...
CONFIG=./configs/my_configs/Libra/reppoints_moment_r50_fpn_2x_BLoss_CELoss_1.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment_r50_fpn_2x_BLoss_CELoss_1 #where to save the models
