...
CONFIG=./configs/my_configs/Libra/reppoints_moment_r50_fpn_2x_BLoss_FLoss_0.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment__r50_fpn_2x_BLoss_FLoss_0 #where to save the models
