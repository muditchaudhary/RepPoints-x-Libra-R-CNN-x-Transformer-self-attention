...
CONFIG=./configs/my_configs/Debugger/debug_CELoss_1_Random_Sampler_noGT.py #specify the config file
WORK_DIR=./work_dirs/debug_CELoss_1_Random_Sampler_noGT #where to save the models
