...
JOB_NAME=reppoints_moment_r50_fpn_2x_BFP #job name can be anything   
CONFIG=./configs/my_configs/Libra/reppoints_moment_r50_fpn_2x_BFP.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment_r50_fpn_2x_train_1gpu_BFP #where to save the models
