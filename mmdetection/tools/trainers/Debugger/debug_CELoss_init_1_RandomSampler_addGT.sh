...
CONFIG=./configs/my_configs/Debugger/debug_CELoss_1_Random_Sampler_addGT.py #specify the config file
WORK_DIR=./work_dirs/debug_CELoss_1_Random_Sampler_addGT #where to save the models
