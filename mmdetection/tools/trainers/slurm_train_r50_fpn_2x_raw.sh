...
JOB_NAME=reppoints_moment_r50_fpn_2x_FYP #job name can be anything   
CONFIG=./configs/my_configs/reppoints_moment_r50_fpn_2x.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment_r50_fpn_2x_train_4gpu_12epoch #where to save the models
