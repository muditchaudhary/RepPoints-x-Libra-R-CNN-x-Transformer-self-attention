...
CONFIG=./configs/my_configs/Empirical_attention/reppoints_moment_r50_fpn_2x_BFP_attn_0010.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment_r50_fpn_2x_BFP_attn_0010 #where to save the models
