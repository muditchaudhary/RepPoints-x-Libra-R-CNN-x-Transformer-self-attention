...
JOB_NAME=reppoints_moment_r50_fpn_2x_BFP_attn_0110 #job name can be anything
CONFIG=./configs/my_configs/Empirical_attention/reppoints_moment_r50_fpn_2x_BFP_KQRattn_0110_stride_1_BRefine.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment_r50_fpn_2x_BFP_KQRattn_0110_stride_1_BRefine #where to save the models
