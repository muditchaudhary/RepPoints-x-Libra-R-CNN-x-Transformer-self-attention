...
JOB_NAME=reppoints_moment_r50_fpn_2x_BLoss1 #job name can be anything   
CONFIG=./configs/my_configs/Libra/reppoints_moment_r50_fpn_2x_BLoss_FLoss_0.1.py #specify the config file
WORK_DIR=./work_dirs/reppoints_moment_r50_fpn_2x_BLoss_FLoss_0.1 #where to save the models
